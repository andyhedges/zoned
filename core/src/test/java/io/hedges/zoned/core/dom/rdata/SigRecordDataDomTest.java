...
class SigRecordDataDomTest {
    ...
    void fromRejectsTooShort() {
        assertThrows(IllegalArgumentException.class, () -> SigRecordDataDom.from(null, RESOLVER));
        assertThrows(IllegalArgumentException.class, () -> SigRecordDataDom.from(new byte[18], RESOLVER));
    }
    ...
    void fromRejectsMissingSignature() {
        ...
        assertThrows(IllegalArgumentException.class, () -> SigRecordDataDom.from(rdata, RESOLVER));
    }
    ...
    void fromParsesFields() {
        ...
        assertEquals(1, sig.typeCovered());
        assertEquals(2, sig.algorithm());
        assertEquals(3, sig.labels());
        assertEquals(10, sig.originalTtl());
    ...
    void toRejectsInvalidFields() {
        SigRecordDataDom negativeType = SigRecordDataDom.builder()
                .typeCovered(-1)
                .algorithm(1)
                .labels(1)
                .originalTtl(0)
        ...
        SigRecordDataDom missingSigner = SigRecordDataDom.builder()
                ...
                .signature(new byte[] {1})
                .build();
        SigRecordDataDom missingSignature = SigRecordDataDom.builder()
                .typeCovered(1)
                .algorithm(1)
                .labels(1)
                .originalTtl(0)
    ...
    void roundTripPreservesFields() {
        ...
        RDataDom decoded = SigRecordDataDom.from(original.to(), RESOLVER);
        SigRecordDataDom parsed = assertInstanceOf(SigRecordDataDom.class, decoded);
